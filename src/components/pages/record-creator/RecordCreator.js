    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            title: Yup.string()
                ...
                .required("Required"),
            amount: Yup.number()
                .typeError("Amount must must be a number")
                .required("Required"),
        ...
        <section className={className}>
            ...
            {accountNames.length ? null : (
                <ErrorMessage>
                    ...
                    <CreateAccountLink to={"/add-accounts"}>
                        Create account
                    </CreateAccountLink>
                </ErrorMessage>
            )}
            ...
            <form onSubmit={formik.handleSubmit}>
                ...
                <SelectorWrapper>
                    ...
                    />
                    {isAccountError && (
                        <ErrorMessage>Account required*</ErrorMessage>
                    )}
                </SelectorWrapper>
            ...
            {isMessageVisible && (
                <Message text="You have successfully added a new record" />
            )}
        </section>
    );
};
